...
from utils.saving_utils import npz_to_video_grid, npz_to_imgsheet_5d
...
# ------------------------------------------------------------------------------------------
def sample_batch_custom(model, noise_shape, condition,
                           sample_type="ddim", 
                           sampler=None,
                           start_timestep=None,
                           end_timestep=None, 
    ...
    if sample_type == "ddpm":
        ...
        samples, _ = ddim_sampler.sample_custom(S=ddim_steps,
